...
class Cash extends Table 
{
    ...
    public function setup($param = []) 
    {
        ...
        $this->addTableCol(array('id'=>'asset_id','type'=>'INTEGER','title'=>'Cashflow Asset','join'=>'name FROM '.TABLE_PREFIX.'asset WHERE asset_id'));
        $this->addTableCol(array('id'=>'asset_id_link','type'=>'INTEGER','title'=>'Linked Asset','join'=>'name FROM '.TABLE_PREFIX.'asset WHERE asset_id'));
